...
import { IAPIResponse, ISignInReducerData } from "@type/Common/Base";
...
const HeaderTop = (props: IHeaderTopState) => {
  ...
  const onChangeSelectedCountry = async (data: ICountryData) => {
    // const countryData = countryList.find((ele) => ele?._id == data?._id);
    await setUpdatedCountryGlobal(
      data?._id,
      ...
      <div className="top-header">
        ...
        <ul>
          ...
          {/* {props?.availablePages?.includes(
            ...
            <li>
              <Link href="/contact-us"><a title="contactUs">Contact Us</a></Link>
            </li>
          )} */}
          {
            <>
              <li>
                <Link href={"/my-wishlist"}>
                  <a>
                    <i title="wishlist" className="jkm-heart" />
                    <span>{reduxData?.signIn?.wishlist_count || 0}</span>
                  </a>
                </Link>
              </li>
              <li>
                <Link href={"/cart/list"}>
                  <a>
                    <i title="cart" className="jkm-add-to-cart" />
                    <span>{reduxData?.signIn?.cart_count || 0}</span>
                  </a>
                </Link>
              </li>
            </>
          ...
          {reduxData?.signIn?.userData?.user_detail?.email ? (
            ...
            <li>
              <Link href="/sign-in">
                <a>
                  <i className="jkm-user" title="user" />
                </a>
              </Link>
            </li>
          )}
