...
import { IToastrProps, IToastFilter } from "@components/Toastr";
...
export const ToastProvider = (props: IToastrProps) => {
  ...
  return (
    ...
    <>
      <ToastContext.Provider
        value={{ contextValue, showError, showSuccess, showWarning }}
      >
        {props.children}
