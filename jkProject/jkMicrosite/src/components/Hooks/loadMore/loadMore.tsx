    ...
    pagesServices?.[apiMethod](postPageAPI, formData)
      .then((result: any) => {
        if (result?.data) {
          ...
          if (apiSectionName === API_SECTION_NAME.collection_list || apiSectionName === API_SECTION_NAME.WISHLIST_DATA ) {
            setLoadedMoreData([
          ...
          }else if(apiSectionName === API_SECTION_NAME.guest_user_wishList || apiSectionName === API_SECTION_NAME.recently_view_list ){
