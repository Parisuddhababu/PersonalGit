...
const FaqListSection1 = (props: Ifaq) => {
  ...
  return (
    <>
      <Head>
        ...
        <link rel="stylesheet" href={getTypeBasedCSSPath(null, CSS_NAME_PATH.popupBoxDesign)} />
        <link rel="stylesheet" href={getTypeBasedCSSPath(null, CSS_NAME_PATH.faq)} />
                ...
                return (
                  <div className="accordion-item" key={uuid()}>
                    ...
                    >
                      ...
                      <span className="jkm-arrow-down" aria-hidden="true"></span>
                    </div>
                    {index === mainIndex && (
...
export default FaqListSection1;
