...
const MyWishlistSection2 = (props: IWishListProps) => {
    ...
    <>
      ...
      {loaderData?.loaderRootReducer?.loadingState ? (
        ...
        <section className="wishlist_section">
          <div className="container">
            <div className="grid-section row">
              {wishListData?.length === 0 ? (
                ...
                wishListData?.map((product: any, eInd) => {
                  return (
                    <ProductBox
                      product={{
          ...
          {showLoadMoreButton && wishListData?.length > 0 && (
...
export default MyWishlistSection2;
