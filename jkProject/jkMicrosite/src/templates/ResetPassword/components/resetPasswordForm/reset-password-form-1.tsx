...
const IResetPasswordForm1 = () => {
  ...
  return (
    <>
      <Head>
        <link rel="stylesheet" href={APPCONFIG.STYLE_BASE_PATH_COMPONENT + 'forgot-password' + ".min.css"} />
        <link
          rel="stylesheet"
          href={
        ...
        <div className="container">
          <div className="forgot-password-wrap">
            <Link href="/forgot-password">
              <a>
                <i className="jkm-arrow-left arrow-left"></i>
              </a>
            </Link>
            <form onSubmit={handleSubmit(submitPassword)}>
              <div className="d-col d-col-2">
                <div className="form-group">
                  ...
                  <div className="form-group-wrapper">
                    ...
                    />
                    <i
                      className="jkm-eye-off hide-show-icon active"
                ...
                <div className="form-group">
                  ...
                  <div className="form-group-wrapper">
                    ...
                    <i
                      ...
                      onMouseUp={() => setPasswordTypeConfirmPassword("password")}
                    ></i>
                  </div>
              ...
              <button
                className="btn btn-primary btn-large reset-pwd"
                type="submit"
                disabled={isDisabled}
              >
                Reset Password
