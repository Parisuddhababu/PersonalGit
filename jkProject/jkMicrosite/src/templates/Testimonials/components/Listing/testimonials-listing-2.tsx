...
const TestimonialsListing2 = (props: ITestimonials) => {
  ...
  return (
    <>
      <Head>
        <link rel="stylesheet" href={getTypeBasedCSSPath('2', CSS_NAME_PATH.testimonialList2)} />
        {/* <link
          rel="stylesheet"
          href={
              ...
              {ListData?.map((ele, eInd) => (
                <div className="d-col d-col-2" key={eInd}>
                  <div className="testimonial-content">
                    <CustomImage src={ele?.image?.path} height="100px" width="100px" />
                    <div className="details">
                      <h4>{ele?.name}</h4>
                      <div className="seperator"></div>
                      <p className="testimonial-para">{ele?.details}</p>
                    </div>
                    <i className="jkms2-quote1 testimonial-icon"></i>
                  </div>
                </div>
              ))}
            </div>
...
export default TestimonialsListing2;
