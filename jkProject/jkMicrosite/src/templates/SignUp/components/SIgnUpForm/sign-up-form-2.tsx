...
import { ISignUpBannerProps } from "@type/Pages/signUp";
...
const SignUpFormSection2 = ({ isGuest = false, SignUpformData }: ISignUpBannerProps) => {
  ...
  return (
    <>
      <Head>
        <link rel="stylesheet" href={APPCONFIG.STYLE_BASE_PATH_COMPONENT + CSS_NAME_PATH.signUp2 + ".min.css"} />
      </Head>
      {/* @ts-ignore */}
      {loaderData?.loaderRootReducer?.loadingState ? (
        ...
        <section className="sign-up-sec ">
            ...
            <div className="sign-up-wrap">
                ...
                <>
                  {socialFacebookId || socialGoogleId ? (
                    <div className="social-links-access">
                      <div className={`row access-links ${socialFacebookId && socialGoogleId ? "" : "single-item"}`}>
                        {socialFacebookId && (
              ...
              <form onSubmit={handleSubmit(onSubmit, onError)}>
                      ...
                      <div className="d-col d-col-2">
                        <div className="form-group">
                          ...
                          <div className="form-group-wrapper">
                            ...
                            />
                            <i
                              className={`${passwordType === "text" ? "jkms2-eye-fill" : "jkms2-eye-off"
                      ...
                      <div className="d-col d-col-2">
                        <div className="form-group">
                          ...
                          <div className="form-group-wrapper">
                            ...
                            />
                            <i
                              className={` ${passwordTypeConfirmPassword === "text" ? "jkms2-eye-fill" : "jkms2-eye-off"
                                } hide-show-icon active`}
                ...
                <input
                  ...
                  value={isGuest ? "SignUp as Guest" : "Register"}
                />
          ...
          <Link href={SignUpformData?.link || ""}>
            <a className="sign-up-bg">
              <CustomImage
                src={SignUpformData?.banner_image?.path || IMAGE_PATH.productBannerJpg}
                alt={SignUpformData?.banner_title}
                title={SignUpformData?.banner_title}
                height=""
                width=""
              />
            </a>
