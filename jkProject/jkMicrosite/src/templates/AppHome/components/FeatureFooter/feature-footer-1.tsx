...
import { IFeatureFooter1 } from ".";
import http from "@util/axios";
import Link from "next/link";

const FeatureFooter1 = () => {
  ...
  const [featureFooter, setFeatureFooterData] = useState<IFeatureFooter1[]>();
  useEffect(() => {
  ...
  return (
    <>
      ...
      <Head>
        <link
          rel="stylesheet"
          href={getTypeBasedCSSPath(null, CSS_NAME_PATH.homeFeatureFooter)}
        />
        <link
          rel="stylesheet"
      ...
      {featureFooter && featureFooter?.length > 0 && (
        <>
          <Script
            src="https://findmyringsize.com/Shared/Embed/fmrs-1.0.js"
            async
          />
          ...
          <section className="features_section">
            ...
            >
              <div className="box">
                <i className="jkm-delivery-truck" />
                <h3>Ready to Ship</h3>
              </div>
            </div>
            <div
            ...
            >
              <div className="box">
                <i className="jkm-new-arrival" />
                <h3>New Arrivals</h3>
              </div>
            </div>
            <div className="d-col d-col-4 just-center">
              <div className="box">
                <i className="jkm-offer" />
                <h3>Offers</h3>
              </div>
            </div> */}
              </div>
