...
const OurStory1 = ({ data }: IOurStoryProps) => {
  ...
  return (
    <>
              ...
              <div className="founder_image">
                ...
                />
                  <a onClick={toggleModal}>
                    <i className="icon jkm-play-icon"></i>
                  </a></> : <CustomImage src={data?.ourstory_single_image?.path ?? ""} height="472px" width="720px" />}
      ...
      <Head>
        <link
          rel="stylesheet"
          href={getTypeBasedCSSPath(null, CSS_NAME_PATH.ourStory)}
        />
      </Head>
    </>
  );
