...
const WebsiteProductDetails1 = (props: IWebsiteProductDetailsProps) => {
  ...
  const [details, setDetails] = useState<IProductDetails>({} as IProductDetails);
  ...
  useEffect(() => {
    if (customDetails && Object.entries(customDetails).length) {
  ...
  // // On page Load Price Break up api calling
  ...
  return (
    <>
      ...
      <Head>
        <link
          rel="stylesheet"
          href={getTypeBasedCSSPath(null, CSS_NAME_PATH.prodDetailComponent)}
        />
      </Head>
      {/* @ts-ignore */}
        ...
        <div className="container">
          <div className="details-left">
            ...
            <div className="product-actions">
              ...
              <a onClick={() => addtoWishList(details)} className={`jkm-box`}>
                <i
                  className={`icon jkm-heart ${details?.is_in_wishlist ? "active jkm-whishlist-fill" : ""
                    }`}
                ></i>
              </a>
            </div>
            <div className="product-slider-box">
              ...
              >
                  ...
                  ))}
                {
                  ...
                  <video width="728px" height="660px" controls autoPlay loop playsInline >
                    ...
                    <source src={selectedImage?.path} type="video/x-msvideo" />
              ...
              <div className="product-thumbnail">
                {details?.website_product_detail?.images?.map((pImage, idx) =>
                  pImage?._id ? (
                    <div
                      className={
                        "thumbnail-img" +
          ...
          <div className="details-right">
              ...
              <div className="price-section">
                {
                  isPriceDisplay && (
                    <strong className="special-price">
                      {details?.price_breakup?.total_price > 0 &&
                        currencySymbol +
                        " " +
                        covertPriceInLocalString(
            ...
            <div className="button-group-section">
              {details?.website_product_detail?.is_customizable === 1 && (
                <button
                  ...
                  onClick={() => {
                    ...
                    //   return;
                    // }
                    setCustomiseView(!isCustomiseView)
                  }}
              ...
              {details?.is_view_price_breakup === 1 && isPriceDisplay && details?.price_breakup?.total_price > 0 && (
                <button
                  type="button"
                  onClick={() => setPriceBreakupView(true)}
                  className="btn btn-view-price"
                >
                  View Price Breakup
                </button>
              )}
            ...
            {isShowProductDetails && details?.price_breakup?.is_fix_price !== 1 && <div className="product-options-section">
              ...
              {details?.website_product_detail?.diamond_details?.length ? (
                <div className="option-box">
                  <strong>
                    <i className="icon jkm-diamond-fill"></i>Diamond{" "}
                  ...
                  {isPriceDisplay ? (
                    <p>
                      {Number(getTotalDiamondCarat()).toFixed(3) +
                        ` ct ${(details?.is_view_price_breakup === 1 && details?.price_breakup?.total_diamond_price > 0)
                          ? `(${currencySymbol} ${covertPriceInLocalString(
                            Math.round(
              ...
              {details?.website_product_detail?.color_stone_details?.length ? (
                <div className="option-box">
                  ...
                  {isPriceDisplay ? (
                    <p>
                      {Number(getTotalColorStone()).toFixed(3) +
                        ` ct ${details?.is_view_price_breakup === 1 && details?.price_breakup
                          ?.total_color_stone_price > 1
                          ? `(${currencySymbol} ${covertPriceInLocalString(
                            Math.round(
                ...
                </div>
                {
                  isB2BUser && !showPrice ? null : (
                    <div className="pincode-wrapper">
                      <div className="form-group ">
                        <label>Check Your Pincode/PostCode</label>
                        <input
                          type="text"
                          className="form-control"
                          name="pincode"
              ...
              <ul>
                {isB2BUser && phone !== "" && <li title="Whatsapp" className="whatsapp">
                  <a onClick={() => openWhatsApp()}>
                    <i className="icon jkm-whatsapp"></i>
                    <span >{phone}</span>
                  </a>
                </li>}
                ...
                {details?.website_product_detail?.product_certificate?.map(
                  (data, eInd) => (
                    <picture key={eInd}>
                      <source
                        src={
                          data.image ? data?.image.path : IMAGE_PATH.noImagePng
                        }
                        type="image/webp"
                      />
                      <source
      ...
      {/* <ProductShipingDetail1 data={details} /> */}
    </>
  );
};
