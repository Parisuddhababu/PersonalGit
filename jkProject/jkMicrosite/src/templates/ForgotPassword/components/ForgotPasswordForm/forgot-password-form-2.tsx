...
const IForgotPasswordForm2 = ({ banner }: { banner?: string }) => {
    ...
    return (
        <>
            ...
            {isLoading && <Loader />}
            <section className="forgot-password-sec" style={{
                background:`url(${banner})`
            }}>
                <div className="container">
                    <div className="forgot-password-wrap">
                        <h3>forgot password</h3>
                        <Link href={'/sign-in'}><a><i className="jkms2-arrow-left arrow-left"></i></a></Link>
...
export default IForgotPasswordForm2;
