...
const DeleteUserModal = ({ onClose, deleteData, editData }: DeleteDataProps) => {
	return (
			...
			<div className='relative w-full min-w-[30vw] max-w-2xl max-h-full shadow-lg'>
				...
				<div className='relative bg-white rounded-lg shadow'>
					...
					<div className='p-6 space-y-2 text-xl text-gray-500 text-center'>
						...
						{editData !== undefined ? <p>Are you sure you want to delete {editData}?</p> : <p>All the data associated with the user will be deleted permanently, Are you sure?</p>}
					</div>
					{/* <!-- Modal footer --> */}
