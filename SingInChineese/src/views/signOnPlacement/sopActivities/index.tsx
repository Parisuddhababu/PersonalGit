...
const SopActivities = () => {
	...
	const getSopActivitiesList = () => {
		...
		APIService.getData(`${URL_PATHS.signOnPlacementAddActivity}/${endPoint.list}?levelId=${params.levelId}`)
			.then((response) => {
	...
	const submitOrderSopActivity = useCallback(() => {
		...
		APIService.patchData(`${URL_PATHS.signOnPlacementAddActivity}/${endPoint.order}?levelId:${params.levelId}`, {
			...
			<div className='mb-3 bg-white shadow-lg rounded-lg overflow-auto'>
				<div className='border-b p-3 flex items-center justify-between'>
					<h6 className='font-medium flex items-center'>
						...
						<button onClick={redirectPathSopActivity}>{params.levelName}</button>
					...
					<div>
						...
						<RoleBaseGuard permissions={[permissionsArray.SOP_ACTIVITY_MANAGEMENT.AddAccess]}>
