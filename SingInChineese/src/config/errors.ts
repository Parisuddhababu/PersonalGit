...
export const Errors = {
	...
	CONFIRM_PASSWORD_NOT_MATCH: 'Confirm password does not match the new password. Please re-enter.',
	...
	CARDS_LESS_THAN_OR_EQUAL_TO: 'Selected cards should be less than or equal to',
	CARDS_GREATER_THAN_OR_EQUAL_TO: 'Selected cards should be greater than or equal to 3.',
	...
	DECIMAL_VALUE: 'Decimal values are the only accepted input. Negative values are not allowed.',
	...
	PLEASE_SELECT_AT_LEAST_ONE_CARD_AS_DEFAULT: 'Please select at least one card as default',
	AUDIO_FILE_DURATION_MUST_LESSTHAN_OR_EQUAL_TO_4_SECONDS: 'Audio file duration must be lessthan or equal to 4 seconds.',
	...
	PLEASE_ENTER_CONTACT_PERSON_NUMBER: 'Please enter contact person number.',
	PLEASE_ENTER_CONTACT_EMAIL: 'Please enter contact email.',
	PLEASE_ENTER_SCHOOL_ADMIN_USER_ID: 'Please enter school admin user id.',
	PLEASE_ENTER_SCHOOL_ADMIN_USER_PASSWORD: 'Please enter school admin user password.',
	PLEASE_SELECT_PAYMENT_TYPE: 'Please select payment type.',
	PHONE_NUMBER_MUST_BE_NUMBERS: 'Phone number must be in numbers only.',
	PHONE_NUMBER_SHOULD_NOT_EXCEED: 'Phone number should not exceed 15 digits.',
	PLEASE_ENTER_INVOICE_DATE: 'Please enter invoice date.',
	PLEASE_ENTER_INVOICE_URL: 'Please enter invoice url.',
	URL_STARTS_WITH: 'URL must start with http:// or https://',
	PLEASE_ENTER_INVOICE_NUMBER: 'Please enter invoice number.',
	PLEASE_SELECT_PAYMENT_STATUS: 'Please select payment status.',
	PLEASE_ENTER_AMOUNT: 'Please enter amount.',

	/* Teacher Management */
	PLEASE_SELECT_SCHOOL_ID: 'Please select school.',
	PLEASE_ENTER_PHONE_NUMBER: 'Please enter phone number.',

	/* Classroom management */
	PLEASE_SELECT_TEACHER_ID: 'Please select teacher.',
	PLEASE_ENTER_NAME: 'Please enter name.',

	/* Student management */
	PLEASE_SELECT_CLASSROOM_ID: 'Please select classroom.',
	PLEASE_ENTER_PARENT_EMAIL: 'Please enter parent email.',
	PLEASE_ENTER_PARENT_BIRTH_YEAR: 'Please enter parent birth year.',
	PLEASE_ENTER_CHILD_FIRST_NAME: 'Please enter child first name.',
	PLEASE_ENTER_CHILD_LAST_NAME: 'Please enter child last name.',
	PLEASE_ENTER_CHILD_DOB: 'Please enter child date of birth.',
	PLEASE_SELECT_PET: 'Please select child pet.',
	PLEASE_SELECT_GENDER: 'Please select gender.',
	PLEASE_SELECT_AVATAR: 'Please select child avatar.',
	PLEASE_ENTER_CHILD_ID: 'Please enter child user id.',
	PLEASE_SELECT_LANGUAGE: 'Please select child language.',
	PLEASE_ENTER_PARENT_FIRST_NAME: 'Please enter parent first name.',
	PLEASE_ENTER_PARENT_LAST_NAME: 'Please enter parent last name.',
	PARENT_BIRTH_YEAR_IN_NUMBERS: 'Parent birth year must be in numbers only.',
};
