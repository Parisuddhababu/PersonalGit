...
> & {
  ...
  sx?: SxProps<Theme>
} & Omit<ControllerProps<T>, 'render'> & { cartQty: number | null }
...
export function NumberElement<T extends FieldValues>(props: NumberFieldElementProps<T>) {
  const {
    DownProps = {},
    UpProps = {},
    inputProps = {},
  ...
  return (
    <Controller
      ...
      render={({
        field: { value = cartQty ? (cartQty.toString() as any) : '', onChange, onBlur },
