...
const Banner = (props) => {
    ...
    if (image && !isImageTag) {
        const resourceImage = getFastlyUrl({
            src: image,
            quality: imageQuality
        })
    ...
    let BannerFragment = (
        <div className="wrapper" style={wrapperStyles} ref={backgroundElement}>
            {videoOverlay}
            <div className={overlayClass} style={overlayStyles}>
                {image && isImageTag ? (
                    ...
                    <>
                        <Image
                            src={desktopImage}
                            className="banner-slider-desktop-img"
                            quality="30"
                            // fill={true}
                            width={1240}
                            height={300}
                        ...
                        <Image
                            src={mobileImage}
                            className="banner-slider-mobile-img"
                            quality="30"
                            // fill={true}
                            width={1240}
                            height={300}
    ...
    return (
        <>
            <Head>
                <link href={image} rel="preload" as="image" />
            </Head>
            <div
