...
// REACT_APP_API_IMAGE_URL= https://basenodeapi.demo.brainvire.dev/api/v1 
// REACT_APP_ENCRYPTION_DECRYPTION_KEY="ABC"
// REACT_APP_API_BASENODE= https://basenodeapi.demo.brainvire.dev