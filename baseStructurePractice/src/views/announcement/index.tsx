...
const Announcement = () => {
	...
	const { data, refetch: getAnnouncement } = useQuery(GET_ANNOUNCEMENTS);
		...
		<div className='mx-6 my-6 mb-14'>
			...
			<div className='mb-3 bg-white shadow-lg rounded-sm overflow-auto border border-[#c8ced3] '>
				...
				<div className='p-3 overflow-auto custom-datatable '>
					...
					{!data?.fetchAnnoucementsWithFilters?.data?.announcementData?.length && <p className='text-center text-red-500'>No Data</p>}
				</div>
