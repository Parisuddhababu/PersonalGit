...
import { AnnouncementRole, ROUTES, SHOW_PAGE_COUNT_ARR } from '@config/constant';
...
import { Calendar, CheckCircle, Cross, Refresh } from '@components/icons';
	...
	return (
		<div>
			<div className='w-full mb-16'>
				<form onSubmit={formik.handleSubmit} className='bg-white shadow-md rounded  pt-6  border border-[#c8ced3] mx-4'>
						...
						<div>
							<div className='w-full grid grid-cols-1 lg:grid-cols-2  gap-6 p-5 '>
								...
								<div>
									...
									<div onClick={toggleDateRangePicker} className='flex justify-between border border-1 border-gray-300 mt-3  p-2 rounded-sm cursor-pointer '>
									...
									{showDateRangePicker && (
										<div className='relative flex-1 flex-col '>
											<DateRange
												ranges={[dateRange]}
												onChange={handleSelect as ((ranges: RangeKeyDict) => void) | undefined}
