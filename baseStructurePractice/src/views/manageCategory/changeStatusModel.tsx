...
import { categoryChangeProps } from 'src/types/category';

const ChangeStatusModel = ({ onClose, changeCategoryStatus }: categoryChangeProps) => {
	return (
		<>
				...
				<div className='flex justify-center'>
					<div className='relative w-[31rem] max-w-2xl max-h-full bg-white '>
						...
						<div className='p-6 space-y-6 text-center'>
							<p>{t('Are you sure you want to change status?')}</p>
						</div>
						{/* <!-- Modal footer --> */}
						<div className=' flex justify-end space-x-2 px-4 pb-4'>
							<Button onClick={changeCategoryStatus} className='btn-primary btn-normal ' type='submit' label={t('Yes')}></Button>
