			...
			<form className='bg-white shadow-lg rounded-sm  border border-slate-300 mx-4 my-4' onSubmit={formik.handleSubmit}>
				...
				<div className='bg-white shadow-md rounded-sm px-8 pt-6 '>
					...
					<div className='grid grid-cols-1 md:grid-cols-2  gap-6 border-t border-gray-200 pt-10'>
						...
						<div>
							<div className='md:mb-4 flex flex-col space-x-2 md:flex-row'>
								{/* logo url  */}
								<div className='flex flex-col w-1/2'>
									<label className='font-normal text-gray-700'>Logo</label>
									<div className='relative border-2 border-[#92B0B3] border-dashed flex flex-col p-auto justify-center h-28 w-32 mx-1 my-2 ' onMouseOver={() => setIsHoverLogo(true)} onMouseOut={() => setIsHoverLogo(false)}>
								...
								<div className='flex flex-col w-1/2'>
									...
									<div className='relative border-2 border-[#92B0B3] border-dashed flex flex-col p-auto justify-center h-28 w-32 mx-1 my-2' onMouseOver={() => setIsHoverFevicon(true)} onMouseOut={() => setIsHoverFevicon(false)}>
