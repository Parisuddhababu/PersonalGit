...
export const GOOGLE_TRANSLATE = 'https://translation.googleapis.com/language/translate/v2';
export const GOOGLE_ANALYTICS = 'https://analyticsdata.googleapis.com/v1beta/properties/';
export const ANALYTICS_SCOPE = 'https://www.googleapis.com/auth/analytics';
