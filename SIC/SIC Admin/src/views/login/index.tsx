			...
			APIService.postData(URL_PATHS.login, {
				...
				.then((response) => {
					if (response.status === ResponseCode.success) {
						...
						localStorage.setItem('authToken', response.data.data.data.token);
						localStorage.setItem('userDetails', JSON.stringify(response.data.data.data.user));
						localStorage.setItem('role', response.data.data.data.user.userType);
