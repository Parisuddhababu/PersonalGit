...
const ContactUsPage = () => {
	...
	const getContactUsDetails = useCallback(() => {
		...
		APIService.getData(`${URL_PATHS.contactUs}/list?page=${filterContactUsData.page}&limit=${filterContactUsData.limit}&sortBy=${filterContactUsData.sortBy}&sortOrder=${filterContactUsData.sortOrder}&search=${filterContactUsData.search}`)
			.then((response) => {
										...
										return (
											<th scope='col' key={colVal.name}>
												<div className='flex items-center'>
													{colVal.name}
													{colVal.sortable && (
														<a onClick={() => onContactUsHandleSort(colVal.fieldName)}>
