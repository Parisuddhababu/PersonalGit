...
const SortableItem = ({ item, editRecord, deleteRecord, editDisable }: DndReadingParagraphSortableTableItem) => {
	const { id } = item;
	...
	return (
		<tr key={item.id} ref={setNodeRef} style={style}>
			...
			<td>
				<audio src={item.traditionalPhrases[0].audio} controls></audio>
			</td>
			<td>
				<audio src={item.simplifiedPhrases[0].audio} controls></audio>
			</td>
