...
import AddEditFlashCardModal from '@views/flashCard/addFlashCard/AddEditFlashCard';
			...
			<Suspense fallback={<LoadingIndicator />}>
				<Routes>
					...
					<Route path={ROUTES.app} element={<DefaultLayout />}>
						...
						<Route path={`${ROUTES.CMS}/${ROUTES.list}`} element={<CMS />} />
						...
						<Route path={`${ROUTES.flashCardList}/:id/AddEditFlashCard`} element={<AddEditFlashCardModal />} />
						<Route path={`${ROUTES.flashCardList}/:id/AddEditFlashCard/:flashcardId`} element={<AddEditFlashCardModal />} />
