      ...
      if (responseData) {
        ...
        _orderData = {
          ...
          date:
            ...
            Constant.NO_VALUE,
          status:
            orderStatusDirectory?.[+responseData?.order_status ?? 1] ?? // NOSONAR
            "Not available",
          paymentStatus:
            responseData?.transactions?.payment_status_text ?? "PAID",
          ...
          shippingAddress: {
            ...
            email: responseData?.user_info?.email ?? Constant.NO_VALUE,
  ...
  return (
    <div className="card">
      ...
      <div className="card-header">
        <h5 className="card-title">Trial Order Details</h5>
      </div>
      ...
      <div className="card-body" style={{ fontSize: "16px" }}>
        ...
        {orderItems?.length > 0 && (
          <fieldset className="fieldset">
            <legend className="legend">Trial Order items</legend>
            ...
            >
              ...
              <Column
                ...
                header="Name"
                style={{ width: "18%" }}
                body={(data) => dynamicBodyTemplate(data["name"])}
              />
              <Column
                field="sku"
                header="SKU"
                style={{ width: "10%" }}
                body={(data) => dynamicBodyTemplate(data["sku"])}
              />
              <Column
                field="itemPrice"
                header="Price"
              ...
              <Column
                ...
                header="Quantity"
                style={{ width: "7%" }}
                body={(data) => dynamicBodyTemplate(data["qty"], 0)}
              />
              <Column
                field="totalPrice"
                style={{ width: "6%" }}
...
export default HcpOrderDetails;
