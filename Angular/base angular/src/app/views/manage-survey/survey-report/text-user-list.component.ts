...
@Component({
  selector: 'app-text-user-list',
  template: `
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">
          <i class="fa fa-user modal-icon"></i>
          {{ 'USERS_LIST' | translate }} [ {{ question }} ]
        </h5>
      ...
      <div class="modal-body">
        ...
        <div class="wrap-datatable">
          <ngx-datatable
            ...
            [messages]="dtMessages"
          >
            <ngx-datatable-column name="{{ 'USERNAME' | translate }}" width="50" prop="username" [sortable]="false"> </ngx-datatable-column>
            <ngx-datatable-column name="{{ 'EMAIL' | translate }}" prop="email" [sortable]="false"> </ngx-datatable-column>
            <ngx-datatable-column name="{{ 'ANSWER' | translate }}" prop="text_answer" [sortable]="false"> </ngx-datatable-column>
          </ngx-datatable>
        </div>
      </div>
...
export class TextUserListComponent implements OnInit {
  quesUuid: any;
  question: string;
  userList: any[] = [];
  ...
  getAnswerForTextType() {
    this.loadingIndicator = true;
    this.surveyService
      .getAnswerForTextType({
        question_uuid: this.quesUuid,
        answer: '',
        name: this.name,
