...
export class SubadminService {
  ...
  getAllSubadminList(SubadminData: any) {
    return this.http.post<any>(CONFIG.getAllSubadminListURL, SubadminData).pipe(
      map((response) => {
        return response;
      })
    );
  ...
  getAllSubadminListForDropdown() {
    return this.http.get<any>(CONFIG.getSubadminListForDropdownURL).pipe(
      map((response) => {
        return response;
      })
    );
  ...
  createSubadmin(SubadminData: Subadmin) {
    return this.http.post<any>(CONFIG.createSubadminURL, SubadminData).pipe(
      map((response) => {
        return response;
      })
    );
