...
export class TreeSelectComponent implements ControlValueAccessor {
  ...
  public constructor(private svc: SelectService, private defaultOpts: TreeSelectDefaultOptions) {
    ...
    this.allowParentSelection =
      defaultOpts.allowParentSelection === undefined || defaultOpts.allowParentSelection === null ? true : defaultOpts.allowParentSelection;
    ...
    this.filterCaseSensitive =
      defaultOpts.filterCaseSensitive === undefined || defaultOpts.filterCaseSensitive === null ? false : defaultOpts.filterCaseSensitive;
