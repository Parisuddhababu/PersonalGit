...
export const CREATE_ROLE = gql`
	${META_FRAGMENT}
	mutation CreateRole($roleName: String!, $description: String!) {
		createRole(role_name: $roleName, description: $description) {
		  data {
			id
			uuid
			role_name
...
export const UPDATE_ROLE_STATUS = gql`
	${META_FRAGMENT}
	mutation UpdateRoleStatus($uuid: UUID!, $status: UserStatus) {
