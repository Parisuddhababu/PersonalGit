				...
				<div className='w-full sm:max-w-wide-2 lg:max-w-wide-3 bg-white rounded py-0 px-1 md:p-6 border border-default'>
					<form onSubmit={formik.handleSubmit}>
						<div className='card-body'>
							<h1 className='text-gray-800 mb-2 font-medium leading-md text-h2'>{('Login')}</h1>
							<p className='text-base-font-1 mb-4 leading-5'>{('Sign In to your account')}</p>
							<div className='mb-4'>
								<TextInput
									placeholder={('Email')}
									name='email'
							...
							<Button className='btn-primary  btn-login ' type='submit' label={('Login')} />
						</div>
					</form>
				</div>
			</div>
