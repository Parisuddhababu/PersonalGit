...
const RolePermission = ({ refetchRoleData }: RoleProps) => {
	...
	const COL_ARR_ROLE = [
		{ name: 'Role Name', sortable: true, fieldName: 'role_name', type: 'text' },
		...
		<div className='card-table'>
			<div className='card-header gap-3 flex-wrap'>
				...
				<div className='w-6/12 pl-4	'>
					<TextInput type='text' id='table-search' value={filterData.search} placeholder={('Search...')} onChange={onSearchRole} />
				</div>
				<RoleBaseGuard permissions={[PERMISSION_LIST.Role.AddAccess]}>
					<div>
						<Button className='btn-primary  ' onClick={createNewRole} type='button' label={('Add New')}>
