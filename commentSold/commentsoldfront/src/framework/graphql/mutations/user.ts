...
export const REGISTER_USER = gql`
	${META_FRAGMENT}
	mutation RegisterUser($firstName: String, $lastName: String, $email: String, $gender: Gender, $password: String, $countryCodeId: String, $phoneNumber: String) {
		registerUser(first_name: $firstName, last_name: $lastName, email: $email, gender: $gender, password: $password, country_code_id: $countryCodeId, phone_number: $phoneNumber) {
		  data {
			uuid
			first_name
			last_name
