				...
				<div className='card-header flex-wrap gap-2'>
					...
					<div className='flex space-x-2 flex-wrap'>
						...
						<div className='btn-group items-center'>
							<button title={AccesibilityNames.Excel} id={'excel'} className='btn btn-success py-1.5 px-3' onClick={onDownload}>
								<span className='w-4 h-5 svg-icon fill-white '>
									<ExcelFile />
								</span>
							</button>
							<button title={AccesibilityNames.PDF} id={'pdf'} className='btn btn-success py-1.5 px-3' onClick={onDownload}>
								<span className='w-4 h-5 svg-icon fill-white '>
									<PdfFile />
								</span>
							</button>
							<button title={AccesibilityNames.CSV} id={'csv'} className='btn btn-success py-1.5 px-3' onClick={onDownload}>
