		...
		<div>
			...
			<div className='card-table'>
				...
				<div className='w-full'>
					<ul className='flex flex-row h-10 w-full border border-b '>
						{navTabsList.map((i) => (
							<NavtabsBsMedia key={i.id} data={i} onClick={navTabHandler} activeTab={activeTab} />
						))}
					</ul>
					<div className='mt-6 w-full'>
						<div className='btn-group flex justify-end mr-5'>
						...
						<div className='card-body'>
							<div className='card-header flex-wrap gap-2 !bg-white border'>
								...
								<div className='btn-group  flex gap-y-2 flex-wrap'>
									<Button className='btn-gray' type='button' onClick={onViewDetails}>
