			...
			<div id='sub-admin-changepassword-model-child' tabIndex={-1} data-modal-show={true} aria-hidden='false' className={' model animate-fade-in'}>
				<div className='model-content'>
					<div className='model-header'>
						...
						<Button onClick={onCloseEnquiryStatus} label={''}>
					...
					<form onSubmit={formik.handleSubmit}>
						<div className='model-body'>
							<DropDown placeholder={t('')} name='status' onChange={formik.handleChange} value={formik.values.status} options={ENQUIRYSTATUSDRP} id='enquiryStatus' required={true} error={formik.errors.status && formik.touched.status ? formik.errors.status : ''} />
						</div>
