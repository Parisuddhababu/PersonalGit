...
import { EditorProps } from 'src/types/component';
import { CK_EDITOR_CONFIGURATION } from '@config/constant';
import FormClassess from '@pageStyles/Form.module.scss';
import { useTranslation } from 'react-i18next';

const EditorComponent: React.FC<EditorProps> = ({ onChange, value, config = CK_EDITOR_CONFIGURATION, error, note, label, required = false, className = '', id }): JSX.Element => {
