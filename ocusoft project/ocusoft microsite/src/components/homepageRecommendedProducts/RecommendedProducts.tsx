...
import { IHomePageRecommededProducts } from ".";

export const HomePageRecommededProducts = (props: {
  data: IHomePageRecommededProducts[],
}) => {
  const {
    slicedData,
    hideRightButton,
    ...
    <section className="products-section">
      <div className="container">
        ...
        <div className="products-wrapper">
          ...
          {slicedData[arrayIndex]?.map((i: IHomePageRecommededProducts) => {
            return (
              <ProductBox
                item={{
