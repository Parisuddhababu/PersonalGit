...
const APICONFIG = {
  ...
  CART_PAGE: `cart/list`,
  GET_PROFILE_DATA: `${BaseURL_V1}/account-information`,
  UPDATE_PROFILE_DATA: `${BaseURL_V1}/account-information/profileUpdate`,
  ...
  PRODUCT_LIST: `${BaseURL_V1}/products`,
  ...
  GET_ADRESS_BOOK_LIST: `${BaseURL_V1}/user-address-book`,
  HOME_PAGE: `${BaseURL_V1}/home`,
  CREATE_ADDRESS_BOOK: `${BaseURL_V1}/user-address-book/create`,
  DELETE_ADDRESS_BOOK: (id: string) =>
    `${BaseURL_V1}/user-address-book/delete/${id}`,
  UPDATE_ADDRESS_BOOK: (id: string) =>
    `${BaseURL_V1}/user-address-book/update/${id}`,
  SHOW_ADDRESS_BOOK: (id: string) =>
    `${BaseURL_V1}/user-address-book/show/${id}`,
  UPDATE_BILLING_SHIPPING_ADDRESS: (id: string) =>
    `${BaseURL_V1}/user-address-book/change-default/${id}`,
  ...
  ABOUT_US: `${BaseURL_V1}/about-us`,

  CATEGORY_LIST: `${BaseURL_V1}/category-list`,
  CHANGE_DEFAULT_ADDRESS: `${BaseURL_V1}/user-address-book/change-default/`,
  SHIPPING_METHODS: `${BaseURL_V1}/shipping-methods`,
  PAYMENT_METHOD: `${BaseURL_V1}/payment-method-detail`,
  PAYMENT_INTENT: `${BaseURL_V1}/stripe_payment/checkout-price-data`,
  SHIPING_RATES: `${BaseURL_V1}/shipping-rate`,
  CANCEL_MY_ORDER: `${BaseURL_V1}/order/cancel-order-request`,
};
