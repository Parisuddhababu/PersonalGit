...
const useValidation = () => {
	const { firstName, lastName, oldPassword, newPassword, confirmPassword, appLanguage, contactNo, favicon, logo, contactEmail, supportEmail, tagLine, siteName, role, title, description, startDate, endDate, bannerTitle, bannerImage, categoryName, parentCategory, email, password, logo1, favicon1, bannerImage1, forgetEmail } = commonValidation();
